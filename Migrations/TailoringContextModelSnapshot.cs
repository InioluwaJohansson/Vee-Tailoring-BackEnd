...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.ArmType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.ClothCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.ClothGender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Complaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.DefaultPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.OrderAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Style", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Template", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Collection", b =>
                {
                    ...
                    b.HasOne("Vee_Tailoring.Entities.ClothGender", "ClothGender")
                        .WithMany()
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Customer", b =>
                {
                    b.HasOne("Vee_Tailoring.Entities.Measurement", "Measurements")
                        .WithMany()
                        .HasForeignKey("MeasurementsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.UserDetails", "UserDetails")
                        .WithMany()
                        .HasForeignKey("UserDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.Identity.User", "User")
                        .WithOne("Customer")
                        .HasForeignKey("Vee_Tailoring.Entities.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Order", b =>
                {
                    b.HasOne("Vee_Tailoring.Entities.ArmType", "ArmType")
                        .WithMany()
                    ...
                    b.HasOne("Vee_Tailoring.Entities.Color", "Color")
                        .WithMany()
                    ...
                    b.HasOne("Vee_Tailoring.Entities.Material", "Material")
                        .WithMany()
                        .HasForeignKey("MaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.OrderAddress", "OrderAddress")
                        .WithMany()
                        .HasForeignKey("OrderAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.OrderMeasurement", "OrderMeasurements")
                        .WithMany()
                        .HasForeignKey("OrderMeasurementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.Pattern", "Pattern")
                        .WithMany()
                        .HasForeignKey("PatternId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.Staff", "Staff")
                        .WithMany()
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vee_Tailoring.Entities.Style", "Style")
                        .WithMany()
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Pattern", b =>
                {
                    b.HasOne("Vee_Tailoring.Entities.ClothCategory", "ClothCategories")
                        .WithMany()
                        .HasForeignKey("ClothCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Vee_Tailoring.Entities.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Post", b =>
                {
                    b.HasOne("Vee_Tailoring.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Staff", b =>
                {
                    ...
                    b.HasOne("Vee_Tailoring.Entities.Identity.User", "User")
                        .WithOne("Staff")
                        .HasForeignKey("Vee_Tailoring.Entities.Staff", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.Template", b =>
                {
                    ...
                    b.HasOne("Vee_Tailoring.Entities.Collection", "Collection")
                        .WithOne("Template")
                        .HasForeignKey("Vee_Tailoring.Entities.Template", "CollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vee_Tailoring.Entities.UserDetails", b =>
                {
                    b.HasOne("Vee_Tailoring.Entities.Address", "Address")
                        .WithMany()
